...
function DialogContent({
  ...
  const closeButtonStyles = closeButtonVariant === 'destructive'
    ? "bg-gradient-to-r from-red-700 to-violet-900 hover:from-red-600 hover:to-violet-800 text-white outline-none rounded-md p-1.5 opacity-100 shadow-lg active:translate-y-0.5 transition-colors duration-150"
