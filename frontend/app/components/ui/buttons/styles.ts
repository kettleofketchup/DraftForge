...
export const brandErrorPrimary = 'bg-gradient-to-r from-red-700/80 to-violet-900/80 border border-red-500/40 hover:from-red-600/80 hover:to-violet-800/80 text-white';
