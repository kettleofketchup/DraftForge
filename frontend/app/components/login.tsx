...
export const ProfileButton : React.FC<UserProps> = () => {
  ...
  return (
    ...
    <div className="dropdown dropdown-end" >
      <div className=" m-0 btn-circle avatar flex p-0 "
         popoverTarget="popover-3" style={{ anchorName: "--anchor-3" } as React.CSSProperties}
         onClick={handleClick}
      ...
      >
        ...
        {user && (
            <>
            <img src={user.avatarUrl} className= "w-12 h-12" />
...
export const LoginButton : React.FC = () => {
  ...
  return (
    ...
    <a className="p-2" href={loginUrl}>
      <button
        className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-400 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
